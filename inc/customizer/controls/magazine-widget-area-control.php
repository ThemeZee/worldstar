...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class WorldStar_Magazine_Widget_Area_Customize_Control extends WP_Widget_Area_Customize_Control {
		 ...
		 */
		function enqueue() {
			wp_enqueue_script( 'worldstar-customizer-magazine-widgets', get_template_directory_uri() . '/assets/js/customizer-magazine-widgets.js', array( 'jquery' ), '20170627', true );
		}
